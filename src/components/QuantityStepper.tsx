  ...
  return (
    <div
      className={`
        ...
        ${isReview ? 'w-[72px] bg-surface' : 'w-20 bg-surface-white'}
      `}
    >
      <button
        type="button"
        ...
        className={`
          ...
          ${isReview ? 'bg-surface-white' : 'bg-surface-alt'} 
      ...
      <span className="flex-1 text-center text-base font-medium leading-5 text-text-dark min-w-3.5">
        {quantity}
      </span>
